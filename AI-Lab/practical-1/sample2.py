...
# ​
# self.clear_selection_for_edge() # Reset selection afterattempting edge creation​
# ​
# ​
...
# for edge in self.edges:​if set(edge["nodes"]) == set([node1, node2]):​
...
# self.canvas.itemconfig(edge["label"], fill="blue")​
# self.root.update()​
# self.root.after(500)​
# break​
# ​
...
# ​
# # Unhighlight edge after returning from recursive call​
# for edge in self.edges:​
# if (edge["nodes"] == (node, neighbor)) or
# (edge["nodes"] == (neighbor, node)):​
# self.canvas.itemconfig(edge["line"], fill="black",
# width=2)​
# if edge["rect"]:​
# self.canvas.itemconfig(edge["rect"],
...
# break​
# ​
# def delete_node_mode(self):​self.clear_selection_for_edge() # Clear any pending edge selection​
...
# connected nodes)")​self.canvas.bind("<Button-1>", self._delete_edge_click)​
# ​

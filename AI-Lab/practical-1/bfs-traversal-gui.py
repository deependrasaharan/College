"""
BFS Traversal Program with GUI
A comprehensive graph builder with visual interface and BFS traversal
"""
...
class GraphGUI:
    """GUI for Graph Builder and BFS Traversal."""
    
    def __init__(self, root):
        self.root = root
        self.root.title("Graph Builder & BFS Traversal - Interactive GUI")
    ...
    def setup_gui(self):
        ...
        info_text = tk.Text(info_frame, wrap=tk.WORD, font=("Arial", 10), height=10)
    ...
    def run_bfs(self):
        ...
        def animate_bfs(queue, visited):
            if not queue:
                ...
                messagebox.showinfo("BFS Complete", f"Traversal: {result_str}")
                return
